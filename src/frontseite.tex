\directlua{format = require("format")}
...
\begin{dsaSheetBox}[.375\textwidth-\fboxsep]
    \begin{tabular}{p{2.5cm}p{\dimexpr\textwidth-4\tabcolsep-2.5cm}}
        \directlua{frontseite.held:links()}
    \end{tabular}
\end{dsaSheetBox}%
%
\begin{dsaSheetBox*}{.25\textwidth}{0pt}
    \setlength{\unitlength}{\textwidth}
    \begin{picture}(1, 1.435)
        \put(0,1.3){\makebox[\unitlength]{\textmansontt{Wappen/Porträt}}}%
        \put(0,0){\directlua{frontseite.held:portrait()}}%
    \end{picture}
\end{dsaSheetBox*}%
%
\begin{dsaSheetBox}[.375\textwidth-\fboxsep]
    ...
    \begin{dsaSheetBox}[.5\textwidth-.5\columnsep]
        \begin{tabular}{p{\dimexpr\textwidth-2\tabcolsep}}
            \directlua{
                ...
                }, data.Vorteile, data.Vorteile.Magisch)
            }
        \end{tabular}
    \end{dsaSheetBox}
...
\begin{dsaSheetBox}[\textwidth]
    \large
    \directlua{
        common.value_line:render(
            {"AP_Gesamt", "AP_Eingesetzt", "AP_Guthaben"}, "40pt", "2.5cm",
