...
\begin{minipage}{12.6cm}
	\begin{dsaSheetBox}[\textwidth]
        ...
        \CodeBefore\rowcolors{2}{white}{gray!30}\Body
            ...
            \dsaTHeading{AT} &
            \dsaTHeading{PA} &
            \dsaTHeading{TP(A)\;\AusdauerschadenSymbol} \\ \Xhline{2\arrayrulewidth}
            \directlua{
	...
	\begin{minipage}{6cm}
        ...
        \begin{dsaSheetBox}
            ...
            \Body
                ...
                \directlua{tex.sprint(-2, data:cur("RS"))} &
                \directlua{tex.sprint(-2, data:cur("BE_voll"))} \\
                \Xhline{2\arrayrulewidth}
                \multicolumn{2}{l|}{
...
\begin{minipage}{\textwidth-12.6cm-\fboxsep}
    \normalfont\bfseries
    \directlua{kampfbogen.trefferzonen()}
\end{minipage}
...
\begin{dsaSheetBox}
    ...
    \colorbox{white}{\parbox[c][12pt][c]{15.4cm}{\small\directlua{kampfbogen.ini()}}}
